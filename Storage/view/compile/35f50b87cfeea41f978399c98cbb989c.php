...
<html lang="en">
	<head>
		<meta charset="UTF-8" />
		<title><?php echo $num?> 份待处理简历 简历管理 </title>
			...
			<!--左侧 我收到的简历-->
			 <div class="sidebar">
			 	...
			 	<dl class="company_center_aside">
			 		<dt>我收到的简历</dt>
			 		<dd  class="current"><a href="<?php echo U('CompanyResume/index')?>">待处理简历</a></dd>
			...
			<!--左侧 我收到的简历  结束-->
			 ...
			 <div class="content">
			 	<dl class="company_center_content">
				 	<dt class="dlTitle"><h1>待处理简历<em></em><span>（共 <?php echo $num?> 份）</span></h1></dt>
				 	<!--简历列表-->
					<dd>
							...
							<div class="filter_actions">
								...
								<script type="text/javascript">
									...
									$(".btn_no").click(function() {
										...
										$.ajax({
											type:"post",
											url:"<?php echo U('CompanyResume/ajaxAll')?>",
											data:{aid:text},
							...
							<?php foreach ($job_actData as $v){?>
								<li>
									...
									<laber class="checkbox">
										<input type="checkbox" name="message" id="" value="<?php echo $v['aid']?>" />
										<i></i>
									</laber>
									<!--/#勾选框-->
									<!--简历个人信息-->
									<div class="resumeShow">
										...
										<div class="resumeIntro">
											...
											<div class="jdpublisher">
												...
												<div class="links">
													<a href="<?php echo U('actFace',array('aid'=>$v['aid']))?>" class="">通知面试</a>
													<a href="<?php echo U('passFunc',array('aid'=>$v['aid']))?>" class="">不合适</a>
												</div>
											</div>
										</div>
										<!--/#简历信息-->
