			...
			<ul class="nav navbar-nav pull-right">
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-default">
						<li>
							<a href="<?php echo U('changePassword')?>">
		...
		<div class="page-sidebar navbar-collapse collapse">
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="<?php echo U('Verify/index')?>">
							审核列表</a>
						</li>
						<li>
							<a href="<?php echo U('Verify/passView')?>">
							通过列表</a>
						</li>
						<li>
							<a href="<?php echo U('Verify/notPassView')?>">
							未通过列表</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="<?php echo U('District/index')?>">
							地区列表</a>
						</li>
						<li>
							<a href="<?php echo U('District/add')?>">
							添加地区</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li>
							<a href="<?php echo U('User/role')?>">
							角色管理</a>
						</li>
						<li>
							<a href="<?php echo U('User/node')?>">
							权限管理</a>
						</li>
					</ul>
				</li>
