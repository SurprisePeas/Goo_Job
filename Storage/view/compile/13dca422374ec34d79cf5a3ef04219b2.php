...
<div class="content">
	...
	<form class="login-form" action="" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" name="aname"/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="验证码" name="code" style="width: 60%;display: inline-block;"/>
			<img src="<?php echo U('Login/code')?>" id="codeimg" onclick="this.src='<?php echo U('Login/code')?>&i='+Math.random()" />
		</div>
		<div class="form-actions">
			<button type="submit" class="btn btn-success uppercase btn-block">登录</button>
		</div>
	</form>
	<!-- END LOGIN FORM -->
