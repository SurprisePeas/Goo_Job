		...
		<div id="Create_container">
			<!--左侧 我收到的简历-->
			 <div class="sidebar">
			 	...
			 	<dl class="company_center_aside">
			 		<dt>我发布的职位</dt>
			 		<dd><a href="<?php echo U('Job/index')?>">有效职位 ( <?php echo $countJobsUp?> )</a></dd>
			 		<dd class="current"><a href="<?php echo U('Job/recycleJob')?>">已下线职位 ( <?php echo $countJobs?> )</a></dd>
			 	</dl>
			 </div>
			<!--左侧 我收到的简历  结束-->
			 ...
			 <div class="content">
			 	<dl class="company_center_content">
				 	<dt class="dlTitle"><h1>已下线职位<em></em><span>（共 <?php echo $countJobs?> 份）</span></h1></dt>
				 	<!--简历列表-->
					<dd>
						<form action="" method="get" id="searchForm">
							...
							<ul class="my_jobs">
								...
								<li>
									<h3><a href=""><?php echo $job['jname']?></a><span> [<?php echo $job['district_name']?>]</span></h3>
									...
									<div class="links fr">
										<a href="javascript:;" reid="<?php echo $job['jid']?>" class="renew" >重新发布</a>
										<a href="javascript:;" delid="<?php echo $job['jid']?>" class="del" >删除</a>
									</div>
								</li>
								<?php }?>
								<!--/#数据-->
