...
<body>
	<div style="margin-top: 10px;margin-bottom: 10px;">
		<a href="<?php echo U('User/index')?>" class="btn btn-primary">用户列表</a>
		<a href="<?php echo U('User/addUser')?>" class="btn btn-warning">添加用户</a>
	</div>
	<form class="form" method="post">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="密码" name="password">
	  </div>
	  <div class="checkbox">
	  	状态：
