	...
	<body>
		<table class="table table-hover">
			...
			<tr>
				...
				<td>
					<a href="javascript:if(confirm('确定?')) location.href='<?php echo U('noPass',array('uid'=>$d['uid']))?>';" class="btn btn-sm btn-danger"> No </a>
					<a href="javascript:if(confirm('确定?')) location.href='<?php echo U('pass',array('uid'=>$d['uid']))?>';" class="btn btn-sm btn-success"> Yes </a>
				</td>
			</tr>
			<?php }?>
		</table>
