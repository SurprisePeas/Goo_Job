...
<body>
	<div style="margin-top: 10px;">
		...
		<a href="<?php echo U('User/roleAdd')?>" class="btn btn-warning">添加角色</a>
	</div>
	<table class="table">
		<thead>
			<tr>
		...
		<tbody>
			<?php foreach ($roleData as $v){?>
				<tr>
					...
					<td>
						<a href="<?php echo U('roleallot',array('id'=>$v['id']))?>" class="btn btn-sm btn-warning" style="background-color: #3071A9;">分配权限</a>
