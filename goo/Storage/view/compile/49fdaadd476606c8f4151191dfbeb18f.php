...
<!--底部登录条-->
		<div id="logintool">
			<div>
				...
				<span class="companycount"> <?php echo $countCom?></span>
				<span class="jobscount"><?php echo $countJob?></span>
						...
						<div class="bcdcenter">
							...
							<script type="text/javascript">
								$("#bcd_login").submit(function(){
									...
									$.ajax({
										type:"post",
										url:"<?php echo U('Login/modalAjax')?>",
										dataType:"JSON",
										data:allre,
							...
							<div class="bcd_right">
								...
								<a href="<?php echo U('Login/register')?>" class="registor_now" target="_blank">
									立即注册
								</a>
