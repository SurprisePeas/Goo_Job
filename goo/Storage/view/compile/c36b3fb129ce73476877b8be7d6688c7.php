...
<body>
    <div class="hd-menu-list">
        <ul>
            ...
            <li>
                <a href="<?php echo U('addRole')?>">添加角色组</a>
            </li>
        ...
        <table class="hd-table hd-table-list hd-form">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo U('givePower',array('rid'=>$r['rid']))?>">分配权限</a>
                        |
                        <a href="<?php echo U('editRole',array('rid'=>$r['rid']))?>">修改</a>
                        |
                        <a href="javascript:;" onclick="del_modal('<?php echo U('delRole',array('rid'=>$r['rid']))?>')">删除</a>
                    </td>
                </tr>
               <?php }?>
            <?php }else{?>
