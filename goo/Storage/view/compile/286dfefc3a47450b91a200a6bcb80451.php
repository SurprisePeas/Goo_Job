	...
	<div class="top_info">
		...
		<div class="top_info_wrap" style="display: block;">
			...
			<div class="company_info">
				<div class="company_main">
					...
					<a href="<?php echo $oldData['url']?>" target="_blank" title=""><h1><?php echo $oldData['cpshortName']?$oldData['cpshortName']:$oldData['cpname']?></h1></a>
		...
		<div class="top_info_edit" style="display: none;">
				<div class="company_logo_edit">
					<!--企业logo图标头像-->
					<img src="<?php echo $oldData['cplogo'] ? $oldData['cplogo'] : './Public/home/imgs/moren/minion.png' ?>" class="mr_headimg" alt="<?php echo $oldData['cpshortName']?>">
				...
				<div class="company_info_edit">
					...
					<label>
						...
						<input type="text" name="cpshortName" maxlength="10" value="<?php echo $oldData['cpshortName']?>" placeholder="请输入公司简称，如：拉勾" />
	...
	<div class="company_navs">
		<div class="company_navs_wrap">
			<ul>
				...
				<!--发布职位统计-->
				<li><a href="CompanyJ_adm.html">招聘职位 (<?php echo $num?>)</a></li>
				<!--<?php echo $oldData['count']?>-->
				<!--/#发布职位统计-->
			</ul>
		</div>
	</div>
		...
		<div class="container_left">
			...
			<div class="item_container" id="company_intro">
				...
				<div class="item_content" >
					<?php echo $oldData['detailed']?>
					<?php if(empty($oldData['detailed'])){?>
               ...
               <?php }?>
				...
				<div class="item_content_edit" style="display: none;">
					...
					<div class="item_main_edit">
						<!--调用百度编辑器-->
						<script id="editor" type="text/plain" style="width:100%;height:1000px;" name="detailed"><?php echo $oldData['detailed']?></script>
					    <script>
