...
<body>
    <form action="" method="post" class="hd-form" name="form" >
        <div class="hd-menu-list">
            <ul>
                <li >
                    <a href="<?php echo U('index')?>">权限列表</a>
                </li>
                <li class="active">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <select name="pid">
								...
								<option value="<?php echo $d['nid']?>" <?php if($d['level']==3){?>
                disabled='disabled'
               <?php }?>><?php echo $d['_name']?></option>
								<?php }?>
                        </select>
                         </td>
                    </tr>
        ...
        <input type="button" value="返回" class="hd-btn hd-btn-sm" onclick="location.href='<?php echo U('index')?>'">
        </form>
</body>
</html>