...
<body>
    <form action="" method="post" class="hd-form" name="form" >
        <div class="hd-menu-list">
            <ul>
                <li >
                    <a href="{:U('AuthGroup/index')}">用户组列表</a>
                </li>
                <li class="active">
                    <a href="javascript:;">编辑用户组</a>
                </li>
            </ul>
        </div>
        
        <div class="hd-title-header">编辑用户组</div>
            ...
            <table class="hd-table hd-table-form">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="rname" class="hd-w200" value="{{$editData['rname']}}"></td>
                    </tr>
                     <!--<tr>
                        <th class="hd-w100">
                            状态
                        ...
                        <td><label> 
                        	...
                        	<label> 
                        	<input type="radio" name="status" value="0" <eq name='data.status' value='0'>checked="checked"</eq>> 禁用  
                        	</label>
                        </td>
                    </tr>-->
                </tbody>
        ...
        <input  type="hidden" name="rid" value="{{$editData['rid']}}" />
