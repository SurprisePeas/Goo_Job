...
<html>
	...
	{{include file="../Common/comHeader"}}
			...
			<ul class="lg_tnav_wrap">
				<li>
					<a href="{{U('Company/index')}}" class="current">
						公司
					</a>
				</li>
				<li>
...
<form action="" method="post">
	<div class="top_info">
		...
		<div class="top_info_wrap" style="display: block;">
			...
			<div class="company_info">
				<div class="company_main">
					...
					<a href="{{U('Company/index',array('cpid'=>$oldData['cpid']))}}" target="_blank" title=""><h1>{{$oldData['cpshortName']?$oldData['cpshortName']:$oldData['cpname']}}</h1></a>
		...
		<div class="top_info_edit" style="display: none;">
				<div class="company_logo_edit">
					<!--企业logo图标头像-->
					<img src="{{$oldData['cplogo'] ? $oldData['cplogo'] : './Public/home/imgs/company/Cgo8PFW3hEiAMZMYAAD1_Ihf0Z4947.jpg' }}" class="mr_headimg" alt="{{$oldData['cpshortName']}}">
				...
				<div class="company_info_edit">
					...
					<label>
						...
						<input type="text" name="cpshortName" id="" value="{{$oldData['cpshortName']}}" placeholder="请输入公司简称，如：拉勾" />
	...
	<div class="company_navs">
		<div class="company_navs_wrap">
			<ul>
				<li><a href="{{U('Company/index')}}">公司主页</a></li>
				<!--发布职位统计-->
				<li class="current"><a href="{{U('Company/jobs')}}">招聘职位 ({{$num}})</a></li>
				<!--/#发布职位统计-->
			</ul>
		</div>
	</div>
