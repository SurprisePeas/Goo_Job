	...
	<body>
		...
		<section class="content_box">
			...
			<div class="left_area" style="margin-top: 20px;">
				...
				<form onsubmit="return hd_submit(this,'{{U('register')}}','{{U('Index/index')}}')">
					<div class="form_body">
						...
						<div class="input_item input2" >
							...
							<img src="{{U('Login/code')}}" class="code_check" onclick="this.src='{{U('Login/code')}}&i='+Math.random()"/></a>
						</div>
						<div class="input_item input2">
			...
			<div class="right_area">
				<h5>已有Goo帐号:</h5>
				<a href="{{U('Login/index')}}" class="login_now">直接登录</a>
				<h5>使用以下帐号直接登录:</h5>
