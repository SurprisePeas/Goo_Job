			...
			<!--左侧 我收到的简历-->
			 <div class="sidebar">
			 	...
			 	<dl class="company_center_aside">
			 		...
			 		<dd class="current"><a href="{{U('infoFace')}}">已通知面试简历</a></dd>
			 		<dd><a href="{{U('pass')}}">不合适简历</a></dd>
			 	</dl>
			...
			<!--左侧 我收到的简历  结束-->
			 ...
			 <div class="content">
			 	<dl class="company_center_content">
				 	<dt class="dlTitle"><h1>已通知面试简历<em></em><span>（共 {{$num}} 份）</span></h1></dt>
				 	<!--简历列表-->
					<dd>
